...
export const IncorporationFAQ = (): JSX.Element => {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "We support various company structures including LLC, Free Zone Company, Mainland Company, and more depending on your jurisdiction and business needs.",
    },
    {
      id: 3,
      question: "How do you ensure accuracy in the incorporation process?",
      answer: "Our AI-powered system combined with expert review ensures all documents are accurate and compliant with local regulations before submission.",
    },
    {
      id: 4,
      question: "Can you advise on which jurisdiction is best for my business?",
      answer: "Yes, our platform provides personalized jurisdiction recommendations based on your business type, target market, and specific requirements.",
    },
    {
      id: 5,
      question: "Do I need to be in the country to set up a business?",
      answer: "No, you can complete the entire incorporation process remotely. We handle all documentation and coordination with local authorities on your behalf.",
    },
    {
      id: 6,
      question: "What documents are required to start the process?",
      answer: "Typically, you'll need passport copies, proof of address, business plan outline, and initial capital details. Specific requirements vary by jurisdiction.",
    },
    {
      id: 7,
      question: "How do I track the progress of my incorporation?",
      answer: "You can track your incorporation status in real-time through your dashboard, which shows each step of the process and any pending actions.",
    },
    {
      id: 8,
      question:
        "Can I apply for visas, licenses, and corporate bank accounts during incorporation?",
      answer: "Yes, we offer integrated services for visas, trade licenses, and corporate banking setup as part of your incorporation package.",
    },
  ];
